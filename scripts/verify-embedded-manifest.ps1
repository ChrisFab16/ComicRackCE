...
.DESCRIPTION
    Post-build gate: PerMonitorV2 must be present in manifest, compiled .res, and linked EXE.
...
Write-Host "HiDPI manifest verification"
...
Write-Host "PASS: PerMonitorV2 verified in manifest pipeline"
exit 0
